    ...
    <table class="wrap-agregar">
        <tr>           
          <td class="text-center">CODIGO_CLIENTE</td>
            ...
            <td class="text-center">NUMERO_FACTURA</td>
        </tr>
        <tr>
            ...
            <td class="text-center">
                <asp:TextBox ID="Tfecha" runat="server" TextMode="DateTimeLocal" Enabled="False"></asp:TextBox>
            </td>
            <td class="text-center">
                <asp:TextBox ID="TnumeroFactura" runat="server" Enabled="False"></asp:TextBox>
            </td>
        </tr>
        <tr>           
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
 <asp:Label ID="Lmensaje"  Class="lmensaje" runat="server" ></asp:Label>
    ...
    <asp:Button ID="Bingresar" runat="server" class="login100-form-btn" Text="Agregar" BackColor="#660066" BorderColor="White" OnClick="Bingresar_Click"/>
     ...
     <asp:Button ID="Bborrar"  class="login100-form-btn"  runat="server" Text="Borrar"/>
     <asp:Button ID="Button2"  class="login100-form-btn"  runat="server" Text="Facturar" OnClick="Button2_Click"/>
